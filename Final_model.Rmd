---
title: "Antibiotic-resistance.Rmd"
...
cat("The steady state for an endemic equilibrium is:", eq$root, "\n")
...
cat("The eigenvalue of the jacobian calculated at the steady state calculated above is:", eigen(jac)$values,"\n")
...
eig <- eigen(J)$values
cat("The eigenvalue of the jacobian calculated at the steady state calculated above is:",eig, "\n") #not stable!
```
...
In conclusion, can see that population B, despite using antibiotics only 50% of the time that they get an infection with Streptococcus Pneumonia, end up with a higher proportion of its population who become carriers of resistant strains no matter how me model the system.
